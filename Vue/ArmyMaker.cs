    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            if (focus)
            {
                ...
                int variance = 3;
                g.DrawRectangle(p, new Rectangle(listBox1.Location.X - variance, listBox1.Location.Y - variance, listBox1.Width + variance, listBox1.Height + variance));
            }
            else
            {
